...
public class UserInfo {
	...
	public UserInfo(String host, String user, String select_priv, String insert_priv, String update_priv,
			String delete_priv, String create_priv, String drop_priv, String reload_priv, String shutdown_priv,
			String process_priv, String file_priv, String grant_priv, String references_priv, String index_priv,
			String alter_priv, String show_db_priv, String super_priv, String create_tmp_table_priv,
			...
			String create_user_priv, String event_priv, String trigger_priv, String create_tablespace_priv,
			String ssl_type) {
		super();
		Host = host;
		User = user;
